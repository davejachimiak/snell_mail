...
describe SharedHelper do
  let(:index_url) { "http://libstaff.neu.edu/snell_mail/users" }
  let(:new_url) { "http://libstaff.neu.edu/snell_mail/users/new" }
