require 'spec_helper'
require_relative './../../lib/snell_mail/message_subjects.rb'
...
describe 'MessageSubjects' do
  ...
  describe 'new instance' do
    it 'requires subjects as an argument' do
      it = Proc.new { SnellMail::MessageSubjects.new }
  ...
  describe '#construct' do
    it 'is responsive' do
      it = SnellMail::MessageSubjects.new(nil)
    ...
    describe 'with one subject' do
      it 'returns neccessary text' do
        ...
        it = SnellMail::MessageSubjects.new(department)
    ...
    describe 'with two subjects' do
      it 'returns neccessary text' do
        ...
        it = SnellMail::MessageSubjects.new(departments)
